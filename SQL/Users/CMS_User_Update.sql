CREATE OR ALTER PROCEDURE CMS_User_Update
    ...
    @Role        NVARCHAR(50), @IsActive BIT, @Department NVARCHAR(100) = NULL,
    @ReportingManagerId BIGINT = NULL, @ActorUserId BIGINT
AS
BEGIN
    UPDATE Users SET Name=@Name, Email=@Email, Username=@Username,
        PhoneNumber=@PhoneNumber, Role=@Role, IsActive=@IsActive, Department=@Department, ReportingManagerId=@ReportingManagerId,
