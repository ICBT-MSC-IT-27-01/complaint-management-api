CREATE OR ALTER PROCEDURE CMS_Report_GetDashboard @ActorUserId BIGINT, @Role NVARCHAR(50)
AS
BEGIN
    SET NOCOUNT ON;
    -- KPI row
    ...
    -- By priority
    SELECT Priority, COUNT(*) AS Count FROM Complaints WHERE IsActive=1 GROUP BY Priority ORDER BY Priority;
END;
GO
